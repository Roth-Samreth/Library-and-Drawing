...
# def moveRight():
#     if canvas.coords(item)[2] < 590:
#         canvas.move(item,+10,0)
# def moveLeft():
#     if canvas.coords(item)[0] > 10:
#         canvas.move(item,-10,0)
# def moveUp():
#     if canvas.coords(item)[1] > 10:
#         canvas.move(item,0,-10)
# def moveDown():
#     if canvas.coords(item)[3]<590:
#         canvas.move(item,0,+10)
# win = tk.Tk()
# win.geometry("600x600")
# frame = tk.Frame()
# frame.master.title("Movement test")
# canvas=tk.Canvas(frame,width=600,height=600)
# item = canvas.create_rectangle(10,10,100,60,fill="dodgerblue")
# def move(event):
#     if event.keysym == "d":
#         moveRight()
#     elif event.keysym == 'a':
...
canvas =tk.Canvas(frame,width=600,height=600,bg="red")
canvas.pack(pady=10)
...
image_size =image_1.resize((100,100))
